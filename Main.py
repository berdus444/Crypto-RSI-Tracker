...
# ---------------- CONFIG ----------------
TELEGRAM_BOT_TOKEN = '8496574766:AAEvDGqsUx43RLeRMMhO-9QnCEBPs2EKPzU'
TELEGRAM_CHAT_ID = '-1003170644595'
INTERVAL = "3m"
RSI_PERIOD = 6
RSI_ALERT_THRESHOLD = 93
RSI_RESET_THRESHOLD = 88  # RESET mantığı eklendi
...
def on_message(ws, message, symbol):
    ...
    try:
        ...
        print(f"{symbol} RSI(6): {rsi:.2f}")

        # === RESET THRESHOLD MANTIĞI ===
        # RSI > 90 olduğunda bildirim gönderilir
        ...
        # RSI < 88 olduğunda resetlenir, yeniden bildirim atılabilir hale gelir
